...
urlpatterns = [
    ...
    path('testimonials/', views.testimonial_view,name='contactus'),
    # path('products/', views.products_view,name='contactus'),
    ...
    path('customersignup', views.customer_signup_view, name='register'),
    path('customerlogin', LoginView.as_view(template_name='ecom/customerlogin.html'),name='customerlogin'),
    path('customer-home', views.customer_home_view,name='customer-home'),
    path('customer-contact', views.customer_contact_view,name='customer-contact'),
